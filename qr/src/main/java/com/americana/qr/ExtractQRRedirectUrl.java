...
*/
    ...
    private void loadWebView(final Context context, final String redirectUrl, final boolean isFromGallery, final String currentCountry) {
        if (webView == null)
    ...
    private void redirectMobUrlInWebView(Context context, final String redirectUrl, final boolean isFromGallery, final String currentCountry) {
    ...
    private void registerHandler(final boolean isFromGallery, final String redirectUrl) {
        if (mHandler == null) {
            mHandler = new Handler();
            mRunnable = new Runnable() {
                @Override
                public void run() {
                    ExtractQRRedirectUrl.this.stopWebViewLoading();
                    ExtractQRRedirectUrl.this.unableToExtrackQR(isFromGallery, false, redirectUrl);
                }
            };
